...
export const getStaticProps = async ({ params }) => {
    ...
    if (!data || !data.title || !data.slug) {
        return {
            notFound: true, // Return a 404 page if the post is invalid
        };
    }
    ...
    // Ensure all properties of prevPost and nextPost are serializable
    const prevPostData = prevPost
        ? {
            ...prevPost,
            title: prevPost.title || null, // Replace undefined title with null
            slug: prevPost.slug || null, // Replace undefined slug with null
        }
        : null;
    ...
    const nextPostData = nextPost
        ? {
            ...nextPost,
            title: nextPost.title || null, // Replace undefined title with null
            slug: nextPost.slug || null, // Replace undefined slug with null
        }
        : null;
